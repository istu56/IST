...
<p align="center">
  <a href="https://dashboard.heroku.com/new?template=https://github.com/istkhar-pvt/ISTKHAR">
...
<h1 align="center">─「 ǫᴜɪᴄᴋ sᴇᴛᴜᴘ 」─</h1>
 ...
 6. **📥 ᴄʟᴏɴᴇ ᴛʜᴇ ʀᴇᴘᴏsɪᴛᴏʀʏ**
   ```bash
   git clone https://github.com/suraj08832/ISTKHARli-MusicV2 && cd ISTKHARli-MusicV2
   ```
...
<p>• ᴛʜɪs <a href="https://github.com/suraj08832/ISTKHARli-MusicV2">sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ</a> ɪs ʀᴇʟᴇᴀsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ <strong><a href="https://github.com/suraj08832/ISTKHARli-MusicV2/blob/main/LICENSE">MIT LICENSE</a></strong> 📜</p>
