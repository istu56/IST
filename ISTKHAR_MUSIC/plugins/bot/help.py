...
from ISTKHAR_MUSIC.help.buttons import BUTTONS
from ISTKHAR_MUSIC.help.helper import Helper
...
async def helper_cb(client, CallbackQuery):
    await CallbackQuery.edit_message_text(Helper.HELP_ISTKHAR, reply_markup=InlineKeyboardMarkup(BUTTONS.SBUTTON))
